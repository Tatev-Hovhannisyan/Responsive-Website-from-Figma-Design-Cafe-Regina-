...
<div className={styles.subscribeContainer}>
  <img src={text1} alt="Text 1" className={`${styles.subText} ${styles.subText1}`} />
  <img src={text2} alt="Text 2" className={`${styles.subText} ${styles.subText2}`} />

  {/* Черный прямоугольник с тенью */}
  <div className={styles.subscribeBlockInner}>
    <img src={text3} alt="Text 3" className={`${styles.subText} ${styles.subText3}`} />
